...
const featureCards = [
  {
    ...
    icon: '/assets/web/color-palette.png',
    accent: '#dff5ec',
  },
  {
    ...
    icon: '/assets/web/user-profile-01.png',
    accent: '#e8f0ff',
  },
  {
  ...
  },
  {
    ...
    icon: '/assets/web/link-angled.png',
    accent: '#e9ecff',
  },
  {
        ...
        <div className="mt-10 rounded-[16px] border border-[#e0d5ff] bg-white p-6 sm:mt-14 sm:rounded-[20px] sm:p-8 md:p-12">
          <div className="grid gap-6 md:grid-cols-2 md:items-center md:gap-8">
            <div className="space-y-4 sm:space-y-6">
              <p className="text-xl font-semibold leading-tight text-[#1a1a1a] sm:text-2xl md:text-3xl">
